...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=700&size=18&pause=1000&color=B794F4&center=true&vCenter=true&width=800&lines=✨+Building+scalable+systems+one+commit+at+a+time;🏺+Uncovering+the+past+through+Digital+Archaeology;🚀+Master's+student+%40+KTH+Royal+Institute;🌠+Exploring+autonomous+robotics+and+AI;💫+Passionate+about+computer+graphics+%26+networking)](https://git.io/typing-svg)
...
struct Sophia sophia = {
    ...
    .education = {
        .current = "MSc Communication Systems @ KTH Royal Institute of Technology",
    ...
    .currentFocus = "Applying Signal Processing & GIS to Heritage Science",
    .funFact = "I use LiDAR to see through forests and Monster to see through code 🟢",
    .codePhilosophy = "// TODO: Preserving the past, building the future 🌌"
};
```
...
### 🌍 Digital Heritage & Mission Control
![GIS](https://img.shields.io/badge/GIS-QGIS%20%7C%20ArcGIS-30:4a148c?style=for-the-badge&logo=qgis&logoColor=white)
![Photogrammetry](https://img.shields.io/badge/Photogrammetry-Meshroom-7b1fa2?style=for-the-badge)
